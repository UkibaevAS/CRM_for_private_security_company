...
class Document(models.Model):
    ...
    series_and_number = models.CharField(max_length=30, null=False, blank=False, db_index=True, help_text=_("format: series number"), verbose_name=_('series_and_number'))
