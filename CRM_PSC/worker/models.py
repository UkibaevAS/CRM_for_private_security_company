...
class Worker(models.Model):
    ...
    date_birth = models.CharField(max_length=10, null=False, blank=False, db_index=True, verbose_name=_('date_birth'))
    data_employment = models.CharField(max_length=10, null=False, blank=False, db_index=True, verbose_name=_('data_employment'))
    ...
    category = models.SmallIntegerField(default=0, null=False, blank=False, db_index=True, verbose_name=_('category'))
    electrical_safety_qualification = models.SmallIntegerField(default=0, null=False, blank=False, db_index=True, verbose_name=_('electrical_safety_qualification'))
