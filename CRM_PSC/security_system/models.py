...
def certificate_directory_path(instance: "Security_system", filename: str) -> str:
...
def maintenance_report_directory_path(instance: "Security_system", filename: str) -> str:
...
def installation_report_directory_path(instance: "Security_system", filename: str) -> str:
    return "installation_report_security_system/maintenance_report_{pk}/{filename}".format(
        pk=instance.pk,
        filename=filename,
    )
