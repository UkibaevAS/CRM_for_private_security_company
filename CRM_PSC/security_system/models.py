...
def copy_certificate_directory_path(instance: Union[
    "Security_system",
    "Alarm_system",
    "Webcam"
],
...
def copy_maintenance_report_directory_path(instance: Union[
    "Security_system",
    "Alarm_system",
    "Webcam"
],
...
def copy_installation_report_directory_path(instance: Union[
    "Security_system",
    "Alarm_system",
    "Webcam"
],
...
class Device(models.Model):
    ...
    certificate = models.FileField(null=True, blank=True, upload_to=copy_certificate_directory_path,
