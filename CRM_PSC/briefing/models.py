...
def briefing_report_directory_path(instance: "Briefing", filename: str) -> str:
    return "briefing/briefing_{pk}/copy/{filename}".format(
        pk=instance.pk,
        filename=filename,
    )
...
class Briefing(models.Model):
    ...
    data_briefing = models.CharField(max_length=10, null=False, blank=False, db_index=True, verbose_name=_('data_briefing'))
    ...
    data_next_briefing = models.CharField(max_length=10, null=False, blank=False, db_index=True, verbose_name=_('data_briefing'))
