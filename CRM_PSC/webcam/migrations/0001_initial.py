    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate', models.ImageField(blank=True, null=True, upload_to=webcam.models.certificate_directory_path, verbose_name='certificate')),
                ...
                ('maintenance_report', models.ImageField(blank=True, null=True, upload_to=webcam.models.maintenance_report_directory_path, verbose_name='maintenance_report')),
            ],
            options={
                'verbose_name': 'Webcam',
